...
do
    ...
    /home/colin/hub/leveldb/build/db_bench --benchmarks="stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=262144 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    ...
    /home/colin/hub/leveldb/build/db_bench --benchmarks="stats,sstables,scan,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=524 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
    sudo du -h /home/colin/hub/testDir >> ${resultFile}
...
do
    ...
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=262144 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
    sudo du -h /home/colin/hub/testDir >> ${resultFile}
    ...
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="stats,sstables,scan,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=524 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
    sudo du -h /home/colin/hub/testDir >> ${resultFile}
...
do
    ...
    # sudo cgexec -g blkio:test_write /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir_raid0" --threads=40 --use_existing_db=1 --reads=262144 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir_raid0" --threads=40 --use_existing_db=1 --reads=262144 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    ...
    free -h >> ${resultFile}
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${ioFile} &
    # sudo cgexec -g blkio:test_write /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="stats,sstables,scan,stats,sstables" --db="/home/colin/hub/testDir_raid0" --threads=40 --use_existing_db=1 --reads=524 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="stats,sstables,scan,stats,sstables" --db="/home/colin/hub/testDir_raid0" --threads=40 --use_existing_db=1 --reads=524 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
    sudo du -h /home/colin/hub/testDir_raid0 >> ${resultFile}
