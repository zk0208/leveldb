...
do
    ...
    /root/leveldb/build/db_bench --benchmarks="overwrite,stats,sstables" --db="/root/testDir" --use_existing_db=1 --num=10485760 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    sudo du -h /root/testDir >> ${resultFile}
