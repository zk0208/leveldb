...
do
    ...
    echo "levelbase readrandom 30Threads end!!!"
    sudo bash -c "echo 1 > /proc/sys/vm/drop_caches"
    ...
    echo "levelbase readrandom 30Threads directio end!!!"
    sudo bash -c "echo 1 > /proc/sys/vm/drop_caches"
...
do
    ...
    echo "blockbase readrandom 30Threads directio end!!!"
    sudo bash -c "echo 1 > /proc/sys/vm/drop_caches"
...
do
    ...
    echo "origin readrandom 30Threads end!!!"
    sudo bash -c "echo 1 > /proc/sys/vm/drop_caches"
    ...
    echo "origin readrandom 30Threads directio end!!!"
    sudo bash -c "echo 1 > /proc/sys/vm/drop_caches"
