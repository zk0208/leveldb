...
do
    ...
    style="google_normal_wtCnums_100G"
    ...
    /home/colin/hub/google_leveldb/build/db_bench --benchmarks="fillrandom,stats,sstables" --db="/home/colin/hub/testDir_raid0" --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    # 中止iostat
    pidof iostat | xargs kill -9
    # if [ ${loop} == 1 ]
    #     then 
