...
do
    ...
    # ../build/db_bench_multipath --benchmarks="fillrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    # if [ ${loop} == 1 ]
    #     then 
    ...
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # ../build/db_bench_multipath --benchmarks="readrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # #scan
    # workload="scan"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # ../build/db_bench_multipath --benchmarks="seekordered,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # #hotread
    # workload="hotread"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # ../build/db_bench_multipath --benchmarks="readhot,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # # update
    # workload="update"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # ../build/db_bench_multipath --benchmarks="overwrite,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    # style="blockbase_normal"

    # # load
    # workload="load"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # /home/colin/hub/my-leveldb/build/db_bench --benchmarks="fillrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    # if [ ${loop} == 1 ]
    #     then 
    ...
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # /home/colin/hub/my-leveldb/build/db_bench --benchmarks="readrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # #scan
    # workload="scan"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # /home/colin/hub/my-leveldb/build/db_bench --benchmarks="seekordered,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # #hotread
    # workload="hotread"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # /home/colin/hub/my-leveldb/build/db_bench --benchmarks="readhot,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # # update
    # workload="update"
    # iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    # echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    # /home/colin/hub/my-leveldb/build/db_bench --benchmarks="overwrite,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench_origin --benchmarks="fillrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    if [ ${loop} == 1 ]
        then 
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench_origin --benchmarks="readrandom,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    #scan
    workload="scan"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench_origin --benchmarks="seekordered,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    #hotread
    workload="hotread"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench_origin --benchmarks="readhot,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # update
    workload="update"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench_origin --benchmarks="overwrite,stats" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
