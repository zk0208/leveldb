...
do
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench --benchmarks="readrandom,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    #scan
    workload="scan"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench --benchmarks="seekordered,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    #hotread
    workload="hotread"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench --benchmarks="readhot,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # update
    workload="update"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    ../build/db_bench --benchmarks="overwrite,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="readrandom,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="readhot,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # update
    workload="update"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="overwrite,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDir" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="readrandom,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
    ...
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="readhot,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --reads=6291456 --num=62914560 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1

    # update
    workload="update"
    iostat -mx 1 3600 /dev/sdb /dev/sdc /dev/sdd /dev/md0 > ${style}IO_${workload}_${workTime}\(${loop}\).txt &
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="overwrite,stats,sstables" --db="/home/colin/hub/YCSB-C-RocksDB/build/testDirRaid" --num=6291456 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${style}OUT_${workload}_${workTime}\(${loop}\).txt 2>&1
