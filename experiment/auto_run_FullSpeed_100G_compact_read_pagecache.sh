...
do
    ...
    # read
    workload="compact_read_40Threads_pagecache"
    ...
    free -h >> ${resultFile}
    ../build/db_bench --benchmarks="stats,sstables,compact,stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=524288 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
...
do
    ...
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${resultFile}
    free -h >> ${resultFile}
    /home/colin/hub/my-leveldb/build/db_bench --benchmarks="stats,sstables,compact,stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir" --threads=40 --use_existing_db=1 --reads=524288 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
    du -h /home/colin/hub/testDir >> ${resultFile}
...
do
    ...
    echo `date +%Y-%m-%d_%H:%M:%S` >> ${resultFile}
    free -h >> ${resultFile}
    /home/colin/hub/leveldb_origin/build/db_bench --benchmarks="stats,sstables,compact,stats,sstables,readrandom,stats,sstables" --db="/home/colin/hub/testDir_raid0" --threads=40 --use_existing_db=1 --reads=524288 --num=104857600 --value_size=1000 --write_buffer_size=67108864 --max_file_size=67108864 >> ${resultFile} #2>&1
    pidof iostat | xargs kill -9
    free -h >> ${resultFile}
    echo "du -h  : " >> ${resultFile}
